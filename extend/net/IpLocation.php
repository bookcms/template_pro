...
class IpLocation
{
    ...
    public function getlocation($ip = '')
    {
        ...
        if (empty($ip)) $ip = \think\facade\Request::ip();
     ...
     * @return array
     */
    public function getUtf8Location($ip = '')
    {
        $location = $this->getlocation($ip);
        if (!empty($location['area'])) {
            $location['area'] = $this->gb2312ToUtf8($location['area']);
        }

        if ($location['country'] != "未知") {
            $location['country'] = $this->gb2312ToUtf8($location['country']);
        }

        return $location;
    }

    private function gb2312ToUtf8($content = '')
    {
