...
class Page {
    ...
    public function showMipPc() {
        ...
        //上一页
        $up_row  = $this->nowPage - 1;
        $up_page = $up_row > 0 ? '<li><a class="prev" data-type="mip" href="' . $this->url($up_row) . '">' . $this->config['prev'] . '</a></li>' : '';

        //没有上一页
        $no_prev = $up_row == 0 ? '<li><a class="no_prev" data-type="mip" href="javascript:void(0)">' . $this->config['prev'] . '</a></li>' : '';
        ...
        $the_first = '';
        if($this->totalPages > $this->rollPage && ($this->nowPage - $now_cool_page) >= 1){
            $the_first = '<li><a class="first" data-type="mip" href="' . $this->url(1) . '">' . $this->config['first'] . '</a></li>';
        }

        //最后一页
        $the_end = '';
        if($this->totalPages > $this->rollPage && ($this->nowPage + $now_cool_page) < $this->totalPages){
            $the_end = '<li><a class="end" data-type="mip" href="' . $this->url($this->totalPages) . '">' . $this->config['last'] . '</a></li>';
        }
        ...
        for($i = 1; $i <= $this->rollPage; $i++){
            ...
            if($page > 0 && $page != $this->nowPage){
                ...
                if($page <= $this->totalPages){
                    $link_page .= '<li><a class="num" data-type="mip" href="' . $this->url($page) . '">' . $page . '</a></li>';
                }else{
                    break;
                }
            }else{
    ...
    public function showMipMobile() {
        ...
        //上一页
        $up_row  = $this->nowPage - 1;
        $up_page = $up_row > 0 ? '<a class="prev" data-type="mip" href="' . $this->url($up_row) . '">' . $this->config['prev'] . '</a>' : '';
        ...
        //下一页
        $down_row  = $this->nowPage + 1;
        $down_page = ($down_row <= $this->totalPages) ? '<a class="next" data-type="mip" href="' . $this->url($down_row) . '">' . $this->config['next'] . '</a>' : '';

        //第一页
        $the_first = '';
        if($this->totalPages > $this->rollPage && ($this->nowPage - $now_cool_page) >= 1){
            $the_first = '<a class="first" data-type="mip" href="' . $this->url(1) . '">' . $this->config['first'] . '</a>';
        }

        //最后一页
        $the_end = '';
        if($this->totalPages > $this->rollPage && ($this->nowPage + $now_cool_page) < $this->totalPages){
            $the_end = '<a class="end" data-type="mip" href="' . $this->url($this->totalPages) . '">' . $this->config['last'] . '</a>';
        }
        ...
        for($i = 1; $i <= $this->rollPage; $i++){
            ...
            if($page > 0 && $page != $this->nowPage){
                ...
                if($page <= $this->totalPages){
                    $link_page .= '<a class="num" data-type="mip" href="' . $this->url($page) . '">' . $page . '</a>';
                }else{
                    break;
                }
            }else{
