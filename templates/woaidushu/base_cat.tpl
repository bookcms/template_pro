...
<style mip-custom>
		...
		.pages {padding: 30px 0;text-align: center;width: 100%;}
		.pages ul  {display:inline-block;}
		.pages ul li {float: left;}
		.pages li span, .pages li a, .pages li b {display: inline-block;margin: 0 2px;padding: 0 15px;height: 36px;line-height: 36px;border: 1px solid #ebebeb;}
		.pages li span {color: #999;}
		.pages li b {background: #0189d0;border: 1px solid #0189d0;color: #fff;}
		.pages li a:hover {background: #0189d0;border: 1px solid #0189d0;color: #fff;}
		.pages li a.no_prev:hover {background: #ebebeb;border: 1px solid #ebebeb;color: #999;}
		.pages li span.current {background: #0189d0;border: 1px solid #0189d0;color: #fff;}
	</style>
</head>
<body>
...
<div class="footer">
	...
	<p class="hidden-xs">Copyright &copy;2017-2019 {$site_config.site_name} All Rights Reserved. </p>
	<p class="visible-xs">本站系基于互联网搜索引擎技术为您提供信息检索服务。</p>
	<p class="visible-xs">Copyright &copy;2017-2019 {$site_config.site_name}说</p>
