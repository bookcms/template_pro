...
<head>
	...
	<title>小说搜索 - {$site_config.site_name}</title>
	<meta name="keywords" content="小说搜索,{$site_config.site_name},热门小说">
	<meta name="description" content="小说搜索,{$site_config.site_name}小说,热门小说">
	...
	<style mip-custom>
		...
		mip-form #mip-form-cross{right: initial!important;}mip-img{float: left;}body:before{position: unset!important;}
	</style>
</head>
<body>
