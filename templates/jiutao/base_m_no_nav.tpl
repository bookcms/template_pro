...
<div class="footer">
    <div class="footer-link">
        ...
        <a href="/disdaimer.html">
            免责声明
        </a>
        <a href="/contact.html">
            意见反馈
        </a>
        <a href="https://www.52sb.vip/" title="{$site_config.site_name}电脑版">
            电脑版
        </a>
    </div>
    <div class="footer-copy">
        &copy; {$site_config.site_domain}    </div>
</div>
<script type="text/javascript" src="__JS__/svg.js"></script>
<script type="text/javascript" src="__JS__/jqscript.js">
</script>
