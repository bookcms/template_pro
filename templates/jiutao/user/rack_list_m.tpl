...
<head>
    <meta charset="utf-8">
    <title>我的书架-{$site_config.site_name} </title>
        ...
        <header id="header" class="header booklist" >
            ...
            <nav class="btn-group btn-group-small">
                <h3 class="btn-group-cell" role="navigation" aria-label="">
                    <a href="{:url('/user/rack_list')}" class="btn-tab active">
                        我的书架
                    </a>
                </h3>
                <h3 class="btn-group-cell" role="navigation" aria-label="已选择">
                    <a href="{:url('/user/collect_list')}" class="btn-tab ">
                        我的收藏
                    </a>
                </h3>
            </nav>
            ...
            <ol id="bookEditOl" class="book-ol book-ol-progress">
                ...
                <li class="book-li">
                    <div class="book-layout">
                        ...
                        <div class="rel">
                            <a href="{$item.read_chapter_url}" class="mybook-to-new">
                                <div class="book-meta">
                                    ...
                                    <p class="ell">{$item.read_chapter_title}</p>
                                </div>
                            </a>
                        </div>
